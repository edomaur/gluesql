...
pub enum StorageError {
    ...
    #[error("[Redb4Storage] unsupported format version v{0}")]
    UnsupportedFormatVersion(u32),
    #[error("[Redb4Storage] unsupported newer format version v{0}")]
    UnsupportedNewerFormatVersion(u32),
    #[error("[Redb4Storage] invalid storage format metadata: missing format version key")]
